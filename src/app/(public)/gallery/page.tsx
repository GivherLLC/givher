...
export async function generateMetadata() {
  return {
    ...
    description: 'Discover our gallery of past events organized for 501(c)(3), 501(c)(4), PACs, candidates, and ballot measures, highlighting our expertise in creating impactful, mission-driven experiences for our clients.',
    openGraph: {
      title: 'Gallery | Givher',
      description: 'Discover our gallery of past events organized for 501(c)(3), 501(c)(4), PACs, candidates, and ballot measures, highlighting our expertise in creating impactful, mission-driven experiences for our clients.',
      url: '/gallery',
