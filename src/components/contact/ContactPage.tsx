          ...
          <div className="flex flex-col lg:flex-row w-full">
            <div className="flex flex-col items-center text-center gap-[2rem] mx-auto max-w-[750px]">
              <h1 className="font-visbyBold text-navySmoke dark:text-softOpal">
                {contactData.contactPageTitle}
              </h1>
              <p className="text-navySmoke dark:text-softOpal">
                {contactData.contactPageSubTitle1}
              </p>
              <p className="text-navySmoke dark:text-softOpal">
                {contactData.contactPageSubTitle2}
              </p>
              <div className="flex gap-[1rem]">
                <Link
                  href={`tel:+1${contactData.contactPhoneNumber}`}
                  className="text-navySmoke dark:text-softOpal"
                >
                  <p className="text-navySmoke dark:text-softOpal hover:underline">
                ...
                <Link
                  ...
                  className="text-navySmoke dark:text-softOpal hover:underline"
                >
                  <p className="text-navySmoke dark:text-softOpal">
