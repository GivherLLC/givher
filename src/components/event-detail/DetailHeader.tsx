...
export default function DetailHeader({event}:{event:EventType}){
    ...
    const { clientName, eventName, eventDateString, eventCity, eventButtonText, eventButtonLink, eventLocation } = event;
        ...
        <div className="bg-navySmoke py-[2.5rem] flex justify-center">
            <div className="flex flex-col sm:flex-row w-full items-center justify-center gap-[2.5rem] max-w-[85.75rem] mx-[0.625rem] lg:mx-[1.5625rem]">
                ...
                <div className="flex flex-col gap-[0.5rem]"></div>
                    ...
                    <h2 className="font-visbyBold text-softOpal text-center md:text-left">{eventCity}</h2>
                    <div className="flex gap-[1rem] md:items-center justify-center md:justify-start">
                        ...
                        <h2 className="uppercase text-softOpal text-[1rem] max-w-[300px] hidden md:block">{clientName}</h2>
                    </div>
                </div>
