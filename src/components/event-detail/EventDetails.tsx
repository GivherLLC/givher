...
export default function EventDetails({event, postponedEventText}:{event:EventType, postponedEventText:string}){
    ...
    return (
        <div className="bg-softOpal dark:bg-navySmoke py-[4.5rem] flex justify-center overflow-hidden">
            <div className="flex flex-col lg:flex-row w-full items-center justify-between lg:justify-between gap-[2.5rem] max-w-[85.75rem] mx-[0.625rem] lg:mx-[1.5625rem]">
                <div className="w-full h-full max-w-[615px] lg:w-1/2 flex flex-col gap-[1rem]">
                    ...
                    {((eventButtonTextOne && eventButtonTextTwo) || (eventButtonTextTwo && eventButtonLinkTwo)) && (
                        <div className="flex">
                            <ArrowLink 
                ...
                <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
                    <Image loading="lazy" height={311} width={322} src={"/images/events/paint-splatter-small.svg"} alt="paint splatter" className="absolute left-[30%] lg:left-[-23%] bottom-[-23%] z-0"/>
