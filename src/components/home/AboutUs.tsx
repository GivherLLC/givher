        ...
        <div className="flex flex-col gap-[4rem] lg:gap-[8rem] w-full">
          {aboutUsSections.map((s, i) => {
            ...
            return (
              <div
                key={s.sectionTitle}
                className={`w-full flex gap-[1rem] lg:gap-[4rem] flex-col-reverse ${even ? 'lg:flex-row' : 'lg:flex-row-reverse'} justify-between mx-auto lg:mx-0`}
              >
                <div
                ...
                >
                  ...
                  <Image
                    ...
                    height={237.5}
                    width={500}
                    className="max-w-[300px] lg:max-w-[500px] xl:max-w-[600px] max-h-[285px] h-auto hidden dark:block"
                  />
                </div>
              </div>
            );
